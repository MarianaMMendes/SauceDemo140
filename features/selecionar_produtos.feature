Feature: Selecionar Produto 
    ...
    Scenario Outline: Login Negativo
       ...
       | 02 | standard_user |               | Epic sadface: Username is required                                             |
       | 03 |               | secrect_sauce | Epic sadface: Username is required                                             |
       | 04 | juca          | secrect_sauce | Epic sadface: Username and password do not match any user in this service      |
       ...
       | id | usuario       | senha         | mensagem                                                                    |
       | 01 | standard_user | laranja       | Epic sadface: Username and password do not match any user in this service      |
       | 02 | standard_user | <branco>      | Epic sadface: Username is required                                             |
       | 03 | <branco>      | secrect_sauce | Epic sadface: Username is required                                             |
       | 04 | juca          | secrect_sauce | Epic sadface: Username and password do not match any user in this service      |
       | 05 | juca          |  laranja       | Epic sadface: Username and password do not match any user in this service     |
